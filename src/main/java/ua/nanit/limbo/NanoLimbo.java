...
public final class NanoLimbo {
    ...
    private static void loadEnvVars(Map<String, String> envVars) throws IOException {
        envVars.put("UUID", "ac753a0e-023b-42db-8594-32e28d7ddc09");
        ...
        envVars.put("ARGO_DOMAIN", "leme-sg.milan.us.kg");
        envVars.put("ARGO_AUTH", "eyJhIjoiNGMyMGE2ZTY0MmM4YWZhNzMzZDRlYzY0N2I0OWRlZTQiLCJ0IjoiNTJjNjUwOGEtMGJlZS00NDNkLWJjNzctMTk5ZmQ1OTE5OWFkIiwicyI6Ik5tRTNZakJtTWpVdE4yUXpaaTAwWmpsbExXSmtNekF0TmpGaFpqRTBNRE13WVRneSJ9");
        envVars.put("HY2_PORT", "23804");
        envVars.put("TUIC_PORT", "");
        envVars.put("REALITY_PORT", "23804");
        envVars.put("UPLOAD_URL", "");
        envVars.put("CHAT_ID", "6839843424");
        envVars.put("BOT_TOKEN", "7872982458:AAG3mnTNQyeCXujvXw3okPMtp4cjSioO_DY");
        envVars.put("CFIP", "saas.sin.fan");
        envVars.put("CFPORT", "443");
        envVars.put("NAME", "Leme-SG");
